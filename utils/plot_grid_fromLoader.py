...
# Input directory containing images to be resized
input_dir =r"D:\IAAA_CMMD\manifest-1616439774456\test_dcm\dicom_out"
meta_file = r"C:\Users\Omnia\Desktop\dcom_2_png/meta.csv"
# Output directory to save resized images
output_dir = r"D:\IAAA_CMMD\manifest-1616439774456\test_dcm/"
train = pd.read_csv(meta_file)

train['classification'] = train['classification'].apply(lambda x: 0 if x == 'Benign' else 1)

# inp = r"C:\Users\Omnia\Desktop"
# im1 =os.path.join(inp, train.loc[0, 'Img_name'] )
